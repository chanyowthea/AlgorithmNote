...
namespace ICSharpCode.SharpZipLib.Zip.Compression 
{
	...
	class InflaterDynHeader
	{
				...
				for (;;) {
					switch (mode) {
						...
						case BLLENS:
                            ...
                            blTree = new InflaterHuffmanTree(blLens, enable_optimize ? 0 : -1);
							blLens = null;
							ptr = 0;
							mode = LENS;
		...
		public InflaterHuffmanTree BuildLitLenTree(bool enable_optimize = false)
		{
            ...
            return new InflaterHuffmanTree(litlenLens, enable_optimize ? 1 : -1);
		}
		...
		public InflaterHuffmanTree BuildDistTree(bool enable_optimize = false)
		{
            ...
            return new InflaterHuffmanTree(distLens, enable_optimize ? 2 : -1);
		}
