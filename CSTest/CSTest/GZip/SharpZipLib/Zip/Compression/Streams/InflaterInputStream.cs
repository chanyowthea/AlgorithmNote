...
namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams 
{
	...
	public class InflaterInputBuffer
	{
        ...
        public void Reset(Stream stream, int bufferSize)
        {
            ...
            if (rawData == null || bufferSize > rawData.Length)
            {
	...
	public class InflaterInputStream : Stream
	{
		...
		public InflaterInputStream(Stream baseInputStream, Inflater inflater, int bufferSize)
		{
			...
			this.inf = inflater;
            this.Reset(baseInputStream, bufferSize);
		}
        ...
        public void Reset(Stream baseInputStream, int bufferSize)
        {
            ...
            if (this.baseInputStream != null && this.IsStreamOwner)
            {
            ...
            if (inputBuffer != null)
            {
                inputBuffer.Reset(baseInputStream, bufferSize);
            }
            else
            {
        ...
        public virtual int OptimizeRead(byte[] buffer, int offset, int count)
        {
            ...
            while (true)
            {
                int bytesRead = inf.Inflate(buffer, offset, remainingBytes,true);
                offset += bytesRead;
                remainingBytes -= bytesRead;
